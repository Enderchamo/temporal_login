...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message) {
        ...
        if (messageType == MessageType.SUCCESS) {
            eMessage.setIcon(new ImageIcon(getClass().getResource("/com/login/icon/success.png")));
        } else {
            eMessage.setIcon(new ImageIcon(getClass().getResource("/com/login/icon/error.png")));
        }
    }
